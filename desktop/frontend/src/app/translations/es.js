const translationsES = {
  ...
  NEW_ADMIN_PAGE: {
    ACCOUNT_FORM: {
      PAGE_TITLE: 'Crea un nuevo admin en <span>plotscore</span>',
      SUBMIT_BUTTON: 'crear admin'
    }
  },
  ...
  SIGNUP_PAGE: {
    ACCOUNT_FORM: {
      ...
      USERNAME: 'Usuario',
      USERNAME_PLACEHOLDER: '3 caracteres como mínimo',
      PASSWORD: 'Contraseña',
  ...
  LANDING_PAGE: {
    ...
    POPULAR_REVIEWS: {
      SECTION_TITLE: 'reviews populares esta semana',
      MORE: 'VER MÁS'
    },
    POPULAR_LISTS: {
  ...
  PROFILE: {
    USER_DETAILS: {
      PRIMARY_BUTTON__EDIT_PROFILE: 'editar perfil',

      /* --------------- */

      PRIMARY_BUTTON__FOLLOW: 'seguir',
      PRIMARY_BUTTON__FOLLOWING: 'siguiendo',
      PRIMARY_BUTTON__UNFOLLOW: 'dejar de seguir',
      ...
      PRIMARY_BUTTON__LINK_COPIED: '¡copiado!'
    }
  },

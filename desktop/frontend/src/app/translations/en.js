const translationsEN = {
  ...
  NEW_MEDIA_PAGE: {
    FORM: {
      PAGE_TITLE: 'Add new content to <span>plotscore</span>',
      SUBMIT_BUTTON: 'add content',

      TITLE_INPUT: 'Title',
      TITLE_INPUT_PLACEHOLDER: '1 character minimum',
      SYNOPSIS: 'Synopsis',
      ...
      ERROR_TEXT: 'An error occurred while adding the content',
  ...
  LANDING_PAGE: {
    ...
    RECENT_STORIES: {
      SECTION_TITLE: 'recent stories',
      MORE: 'MORE'
    },
    RECENT_SHOWDOWNS: {
      SECTION_TITLE: 'recent showdowns',
      MORE: 'MORE'
    },
    RECENT_NEWS: {
  ...
  USER_HOME: {
    WELCOME_TEXT: {
      TEXT_LEFT: 'Welcome ',
      TEXT_RIGHT: '. Here\'s what your friends have been watching...'
    },

    /* ---------------------------------------- */

    NEW_ON_PLOTSCORE: {
      SECTION_TITLE: 'new on plotscore',
      ALL_MEDIA: 'ALL MEDIA'
    },
    GENERAL_ACTIVITY: {
